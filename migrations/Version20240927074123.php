 ...
 */
final class Version20240924093427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participant (id INT AUTO_INCREMENT NOT NULL, participant_campus_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, mot_passe VARCHAR(255) NOT NULL, actif TINYINT(1) NOT NULL, roles JSON NOT NULL, INDEX IDX_D79F6B116C5F9AC5 (participant_campus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sortie (id INT AUTO_INCREMENT NOT NULL, sortie_lieu_id INT DEFAULT NULL, sortie_etat_id INT DEFAULT NULL, sortie_campus_id INT DEFAULT NULL, sortie_participant_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date_heure_debut DATETIME NOT NULL, duree TIME NOT NULL, date_limite_inscription DATETIME NOT NULL, nb_inscription_max INT NOT NULL, infos_sortie VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, INDEX IDX_3C3FD3F2A86218A1 (sortie_lieu_id), INDEX IDX_3C3FD3F2CF8E8D92 (sortie_etat_id), INDEX IDX_3C3FD3F2E8DC5B53 (sortie_campus_id), INDEX IDX_3C3FD3F2480BB42B (sortie_participant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
